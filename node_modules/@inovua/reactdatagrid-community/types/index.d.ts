...
import { MutableRefObject, ReactNode, CSSProperties, ReactElement } from 'react';
...
export { TypeFilter, TypeFilterValue, TypeSingleFilterValue, TypeFilterType, TypeFilterTypes, TypeFnParam, TypeFilterOperator, TypeFilterParam, } from './TypeFilterValue';
...
export type TypeShowGroupSummaryRow = 'start' | 'end' | boolean | ((group: TypeGroupDataItem) => 'start' | 'end' | boolean);
export type TypeCollapsedGroups = true | {
    [key: string]: boolean;
};
export type TypeExpandedGroups = TypeCollapsedGroups;
export type TypeGetColumnByParam = string | number | TypeComputedColumn | {
    id: string | number;
    name?: string | number;
} | {
    name: string | number;
...
export type TypePlugin = {
    ...
    renderColumnContextMenu?: (computedProps: TypeComputedProps, computedPropsRef: MutableRefObject<TypeComputedProps | null>) => void | {} | null;
    renderRowContextMenu?: (computedProps: TypeComputedProps, computedPropsRef: MutableRefObject<TypeComputedProps | null>) => void | {} | null;
    renderColumnFilterContextMenu?: (computedProps: TypeComputedProps, computedPropsRef: MutableRefObject<TypeComputedProps | null>) => void | {} | null;
    renderRowResizeIndicator?: (computedProps: TypeComputedProps, computedPropsRef: MutableRefObject<TypeComputedProps | null>) => ReactElement;
    renderLicenseNotice?: (computedProps: TypeComputedProps, computedPropsRef: MutableRefObject<TypeComputedProps | null>) => void;
    Footer?: TypePlugin;
};
