...
export type TypeRowReorderFn = ({ dragRowIndex, insertRowIndex, }: TypeRowReorderParam) => void;
export type TypeRowReorder = TypeRowReorderFn | boolean;
export type TypeRowExpandHeightFunction = ({ data }: {
    data: any;
}) => number;
export type EnumRowDetailsWidth = 'max-viewport-width' | 'min-viewport-width' | 'viewport-width';
...
type TypeDataGridPropsNoI18n = {
    ...
    onRowReorder?: TypeRowReorder;
    onGroupRowReorderStart?: ({ data, dragIndex, dragGroup, }: {
        data: any;
        dragIndex: number;
        dragGroup: string;
    }) => void;
    onRowReorderStart?: ({ data, dragIndex, }: {
        data: any;
        dragIndex: number;
    }) => void;
    onGroupRowReorderEnd?: ({ data, dropIndex, dropGroup, }: {
        data: any;
        dropIndex: number;
        dropGroup: string;
    }) => void;
    onRowReorderEnd?: ({ data, dropIndex, }: {
        data: any;
        dropIndex: number;
    }) => void;
    ...
    setColumnsSizesAuto?: ({ columnIds, skipHeader, skipSortTool, }: {
        columnIds?: string[];
        skipHeader?: boolean;
...
export type TypeDataGridProps = TypeDataGridPropsNoI18n & TypeDataGridComputedClashingProps;
...
export type TypeComputedProps = TypeDataGridPropsNoI18n & {
    ...
    computedCellDoubleClick?: (event: MouseEvent, cellProps: TypeCellProps) => void;
    ...
    setItemOnReorderingGroups: (index: number, item: {
        [key: string]: any;
    }, config?: {
        replace?: boolean;
    }) => void;
